...
parser.add_argument('--medium', action='store_true', 
        help='Generate the medium IMF spectrogram and not the high IMF spectrogram')
...
if args.medium:
    medium_IMF_espec = get_espec("/home/nathan/data/2018-Fri-Jan-26/pluto-1/data", range(-11,11), traj=(points, o))
