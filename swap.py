...
if __name__ == '__main__':
    ...
    points, o = trajectory(NH_tools.close_start, NH_tools.close_end, 60.)
    
    xp = xp[(tags != 0)]# & (mrat == 1./16.)]
    v = v[(tags != 0)]# & (mrat == 1./16.)]
    beta = beta[(tags != 0)]# & (mrat == 1./16.)]
    mrat = mrat[(tags != 0)]# & (mrat == 1./16.)]
